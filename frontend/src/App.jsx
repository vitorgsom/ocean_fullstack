 ...
 * Desafios!
 * 
 * HTML/CSS; Criação de componente.
 * 1. Criar um componente <Header /> que possua um logo na esquerda e dois itens
 * clicáveis:
 * - Home
 * - Criar 2. Estilizar o Header com uma cor de fundo, o logo com tamanho pequeno e os
 * itens com uma cor que contraste bem com o fundo 
 * 
 ...
 * 5. Estilize o componente <Tag/> para ter uma cor de fundo que constraste com
 * o card.
